#pragma once
/////////////////////////////////////////////////////////////////////
// PublisherExecutive.h - Organizes and Directs Code Analysis      //
// ver 1.4                                                         //
//-----------------------------------------------------------------//
...
*  Maintanence History:
*  --------------------
*  ver 1.5 : 1 April 2017
*  - added functions related to the Publisher package
*  ver 1.4 : 26 Feb 2016
...
namespace CodeAnalysis
{
	...
	///////////////////////////////////////////////////////////////////
	// PublisherFileMgr class derives from FileManager::FileMgr
	// - provides application specific handling of file and dir events

	class PublisherFileMgr : public FileManager::FileMgr
	{
	public:
		...
		PublisherFileMgr(const Path& path, FileMap& fileMap);
	...
	///////////////////////////////////////////////////////////////////
	// PublisherExecutive class directs C++ and C# code analysis

	class PublisherExecutive
	{
	public:
		using Path = std::string;
		using Pattern = std::string;
		...
		PublisherExecutive();
		virtual ~PublisherExecutive();

		PublisherExecutive(const PublisherExecutive&) = delete;
		PublisherExecutive& operator=(const PublisherExecutive&) = delete;
		...
		virtual void processSourceCode1(bool showActivity);
	...
	private:
		...
		std::string depXmlFile_;
		std::string strongCompXmlFile_;
