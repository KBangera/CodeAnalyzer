...
void ClientHandler_MsgServer::operator()(Socket& socket_)
{
  while (true)
  {
...
*/
bool ClientHandler_MsgServer::testStringHandling(Socket& socket_)
{
...
*/
bool ClientHandler_MsgServer::testBufferHandling(Socket& socket_)
{
