...
void CodeAnalysis::Publisher::createHTML(std::string htmlFile)
{
	...
	ssObj << htmlPrologue(FileSystem::FileInfo::FileInfo(htmlFile).name());
	ssObj << "\n<!DOCTYPE html>\n";
	ssObj << "<html>\n";
	std::cout << "\n=================\n";
...
//function to add the html page prologue
std::string CodeAnalysis::Publisher::htmlPrologue(std::string file)
{
	std::stringstream ssObj;
	ssObj << "\n<//////////////////////////////////////\n";
	ssObj << file << "\n";	
